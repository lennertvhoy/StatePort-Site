#!/bin/sh
# StatePort v0.1.0-alpha.11 Windows 11 + WSL2 + Ubuntu 24.04 bootstrap.
set -eu
STATEPORT_VERSION="0.1.0-alpha.11"
RELEASE_ROOT="https://lennertvhoy.github.io/StatePort-Site/download/0.1.0-alpha.11"
PROBE_ROOT="https://lennertvhoy.github.io/StatePort-Site/download/alpha11-manifests"
...
if [ "$mode" = probe ]; then
  ...
  umask 077
  tmp=$(mktemp -d "${TMPDIR:-/tmp}/stateport-alpha11-probe.XXXXXX") || fail "Cannot create a private probe directory."
  trap 'rm -rf "$tmp"' EXIT
  trap 'exit 129' HUP
  trap 'exit 130' INT
  trap 'exit 143' TERM
  get "$PROBE_ROOT/stateport-api.json" "$tmp/stateport-api.manifest.json" "image manifest: stateport-api"
  check "bc15758766b9cceeb842b935415a12087bd5269c0cc5125ce939b4be0b0a11fc" "$tmp/stateport-api.manifest.json"
  ...
  check "af767264b264cfbdc88ff3d4c32736fc6da9ebbb3e043c7450ebd5154b4d715d" "$tmp/stateport-dev-workspace.manifest.json"
  ...
  check "58f2e6b9541f06bc26bf23b509dc359c7886274c0a80af3e5a58d958550693e9" "$tmp/stateport-execution-host.manifest.json"
  get "$PROBE_ROOT/stateport-playwright.json" "$tmp/stateport-playwright.manifest.json" "image manifest: stateport-playwright"
  check "b7e9b2cbe65f80e99575e1baf09cc7f1900c6ed268cf81f15528baa84af64775" "$tmp/stateport-playwright.manifest.json"
  get "$PROBE_ROOT/stateport-runner.json" "$tmp/stateport-runner.manifest.json" "image manifest: stateport-runner"
  check "b220a447485fbf2180d23f76899a37f1ba3347925b37bfdf725584387882b6ce" "$tmp/stateport-runner.manifest.json"
  get "$PROBE_ROOT/stateport-web.json" "$tmp/stateport-web.manifest.json" "image manifest: stateport-web"
  check "e09ab3f6aa6ac8316ed265c2d855ef35405253f0579d7033d1ff3f53cafc6591" "$tmp/stateport-web.manifest.json"
  get "$PROBE_ROOT/stateport-worker.json" "$tmp/stateport-worker.manifest.json" "image manifest: stateport-worker"
  check "84c21888edbbcb200d1d9df8b5f2c5c957af15a21afb47135854d7eae49f07bc" "$tmp/stateport-worker.manifest.json"
  printf "StatePort Alpha.11 transport probe passed: bootstrap syntax and 7 exact image manifests verified; installer was not executed.\n"
  exit 0
fi
if [ "$mode" = materialization-preflight ]; then
  ...
  umask 077
  tmp=$(mktemp -d "${TMPDIR:-/tmp}/stateport-alpha11-materialization.XXXXXX") || fail "Cannot create a private preflight directory."
  trap 'rm -rf "$tmp"' EXIT
  trap 'exit 129' HUP
  trap 'exit 130' INT
  trap 'exit 143' TERM
  ...
  printf "StatePort Alpha.11 materialization preflight passed: target, pinned helper transport, and absent-parent creation order verified; packages, root files, images, and installer were not changed or executed.\n"
  exit 0
fi
...
check "5f4d43a9d058e1f972166b9040295ca178774b20143aa808c2b234cdf1d963fb" "$tmp/updater"
get "$RELEASE_ROOT/release-index.json" "$tmp/release-index.json" "signed release index"
check "8a26f7d36b5c6883c314db7323c4a79a497e0973e0ec671c02c6b38f0f533f2c" "$tmp/release-index.json"
get "$RELEASE_ROOT/release-index.sigstore.json" "$tmp/release-index.sigstore.json" "release index signature"
check "01b228ec64cee2c46d17db5279766d1ef39612a94c4309516f4c7ce08aa957b4" "$tmp/release-index.sigstore.json"
...
check "da19bd224d9dc5ab6f486a6f6ace3dc47e03e350b0cb8e52fd9afca534d55609" "$tmp/image-bundles/stateport-api.sigstore.json"
...
check "30a8f0aaf82ec37803b5ca26f50163027f84597017f595cf61cfb5df3f032b39" "$tmp/image-bundles/stateport-dev-workspace.sigstore.json"
...
check "4054e790a5b218455b8982a56487c056f1f71189011d1c82f1a31cfb33510771" "$tmp/image-bundles/stateport-execution-host.sigstore.json"
...
check "dcf384ae4482f603527d16d1d1677742a8ee41606d08c9bcf5477bab29f42db0" "$tmp/image-bundles/stateport-playwright.sigstore.json"
...
check "c236385e2e23c2f1e2a1952fb905a94ad638e333deb0e812329b8afb43565416" "$tmp/image-bundles/stateport-runner.sigstore.json"
...
check "73623ea67975102dc5dd2e95c07d1728facc893858f74559ef18779cdf49db09" "$tmp/image-bundles/stateport-web.sigstore.json"
...
check "4001597ce5d0af6370a3ef29848bb7ff05e280c4f7510ae0336ce4c6dc60152f" "$tmp/image-bundles/stateport-worker.sigstore.json"
...
check "bc15758766b9cceeb842b935415a12087bd5269c0cc5125ce939b4be0b0a11fc" "$tmp/image-manifests/stateport-api"
...
cp "$tmp/image-manifests/stateport-api" "$tmp/image-carriers/stateport-api/blobs/sha256/bc15758766b9cceeb842b935415a12087bd5269c0cc5125ce939b4be0b0a11fc"
printf '{"schemaVersion":2,"manifests":[{"digest":"sha256:bc15758766b9cceeb842b935415a12087bd5269c0cc5125ce939b4be0b0a11fc"}]}\n' > "$tmp/image-carriers/stateport-api/index.json"
tar -cf "$tmp/image-archives/stateport-api.oci.tar" --sort=name --mtime=@0 --owner=0 --group=0 --numeric-owner -C "$tmp/image-carriers/stateport-api" index.json "blobs/sha256/bc15758766b9cceeb842b935415a12087bd5269c0cc5125ce939b4be0b0a11fc"
...
check "af767264b264cfbdc88ff3d4c32736fc6da9ebbb3e043c7450ebd5154b4d715d" "$tmp/image-manifests/stateport-dev-workspace"
...
cp "$tmp/image-manifests/stateport-dev-workspace" "$tmp/image-carriers/stateport-dev-workspace/blobs/sha256/af767264b264cfbdc88ff3d4c32736fc6da9ebbb3e043c7450ebd5154b4d715d"
printf '{"schemaVersion":2,"manifests":[{"digest":"sha256:af767264b264cfbdc88ff3d4c32736fc6da9ebbb3e043c7450ebd5154b4d715d"}]}\n' > "$tmp/image-carriers/stateport-dev-workspace/index.json"
tar -cf "$tmp/image-archives/stateport-dev-workspace.oci.tar" --sort=name --mtime=@0 --owner=0 --group=0 --numeric-owner -C "$tmp/image-carriers/stateport-dev-workspace" index.json "blobs/sha256/af767264b264cfbdc88ff3d4c32736fc6da9ebbb3e043c7450ebd5154b4d715d"
...
check "58f2e6b9541f06bc26bf23b509dc359c7886274c0a80af3e5a58d958550693e9" "$tmp/image-manifests/stateport-execution-host"
...
cp "$tmp/image-manifests/stateport-execution-host" "$tmp/image-carriers/stateport-execution-host/blobs/sha256/58f2e6b9541f06bc26bf23b509dc359c7886274c0a80af3e5a58d958550693e9"
printf '{"schemaVersion":2,"manifests":[{"digest":"sha256:58f2e6b9541f06bc26bf23b509dc359c7886274c0a80af3e5a58d958550693e9"}]}\n' > "$tmp/image-carriers/stateport-execution-host/index.json"
tar -cf "$tmp/image-archives/stateport-execution-host.oci.tar" --sort=name --mtime=@0 --owner=0 --group=0 --numeric-owner -C "$tmp/image-carriers/stateport-execution-host" index.json "blobs/sha256/58f2e6b9541f06bc26bf23b509dc359c7886274c0a80af3e5a58d958550693e9"
get "$PROBE_ROOT/stateport-playwright.json" "$tmp/image-manifests/stateport-playwright" "image manifest: stateport-playwright"
check "b7e9b2cbe65f80e99575e1baf09cc7f1900c6ed268cf81f15528baa84af64775" "$tmp/image-manifests/stateport-playwright"
...
cp "$tmp/image-manifests/stateport-playwright" "$tmp/image-carriers/stateport-playwright/blobs/sha256/b7e9b2cbe65f80e99575e1baf09cc7f1900c6ed268cf81f15528baa84af64775"
printf '{"schemaVersion":2,"manifests":[{"digest":"sha256:b7e9b2cbe65f80e99575e1baf09cc7f1900c6ed268cf81f15528baa84af64775"}]}\n' > "$tmp/image-carriers/stateport-playwright/index.json"
tar -cf "$tmp/image-archives/stateport-playwright.oci.tar" --sort=name --mtime=@0 --owner=0 --group=0 --numeric-owner -C "$tmp/image-carriers/stateport-playwright" index.json "blobs/sha256/b7e9b2cbe65f80e99575e1baf09cc7f1900c6ed268cf81f15528baa84af64775"
get "$PROBE_ROOT/stateport-runner.json" "$tmp/image-manifests/stateport-runner" "image manifest: stateport-runner"
check "b220a447485fbf2180d23f76899a37f1ba3347925b37bfdf725584387882b6ce" "$tmp/image-manifests/stateport-runner"
...
cp "$tmp/image-manifests/stateport-runner" "$tmp/image-carriers/stateport-runner/blobs/sha256/b220a447485fbf2180d23f76899a37f1ba3347925b37bfdf725584387882b6ce"
printf '{"schemaVersion":2,"manifests":[{"digest":"sha256:b220a447485fbf2180d23f76899a37f1ba3347925b37bfdf725584387882b6ce"}]}\n' > "$tmp/image-carriers/stateport-runner/index.json"
tar -cf "$tmp/image-archives/stateport-runner.oci.tar" --sort=name --mtime=@0 --owner=0 --group=0 --numeric-owner -C "$tmp/image-carriers/stateport-runner" index.json "blobs/sha256/b220a447485fbf2180d23f76899a37f1ba3347925b37bfdf725584387882b6ce"
get "$PROBE_ROOT/stateport-web.json" "$tmp/image-manifests/stateport-web" "image manifest: stateport-web"
check "e09ab3f6aa6ac8316ed265c2d855ef35405253f0579d7033d1ff3f53cafc6591" "$tmp/image-manifests/stateport-web"
...
cp "$tmp/image-manifests/stateport-web" "$tmp/image-carriers/stateport-web/blobs/sha256/e09ab3f6aa6ac8316ed265c2d855ef35405253f0579d7033d1ff3f53cafc6591"
printf '{"schemaVersion":2,"manifests":[{"digest":"sha256:e09ab3f6aa6ac8316ed265c2d855ef35405253f0579d7033d1ff3f53cafc6591"}]}\n' > "$tmp/image-carriers/stateport-web/index.json"
tar -cf "$tmp/image-archives/stateport-web.oci.tar" --sort=name --mtime=@0 --owner=0 --group=0 --numeric-owner -C "$tmp/image-carriers/stateport-web" index.json "blobs/sha256/e09ab3f6aa6ac8316ed265c2d855ef35405253f0579d7033d1ff3f53cafc6591"
get "$PROBE_ROOT/stateport-worker.json" "$tmp/image-manifests/stateport-worker" "image manifest: stateport-worker"
check "84c21888edbbcb200d1d9df8b5f2c5c957af15a21afb47135854d7eae49f07bc" "$tmp/image-manifests/stateport-worker"
...
cp "$tmp/image-manifests/stateport-worker" "$tmp/image-carriers/stateport-worker/blobs/sha256/84c21888edbbcb200d1d9df8b5f2c5c957af15a21afb47135854d7eae49f07bc"
printf '{"schemaVersion":2,"manifests":[{"digest":"sha256:84c21888edbbcb200d1d9df8b5f2c5c957af15a21afb47135854d7eae49f07bc"}]}\n' > "$tmp/image-carriers/stateport-worker/index.json"
tar -cf "$tmp/image-archives/stateport-worker.oci.tar" --sort=name --mtime=@0 --owner=0 --group=0 --numeric-owner -C "$tmp/image-carriers/stateport-worker" index.json "blobs/sha256/84c21888edbbcb200d1d9df8b5f2c5c957af15a21afb47135854d7eae49f07bc"
...
sudo -n sh -c 'printf "%s  %s\n" "$1" "$2" | sha256sum -c --status' sh "8a26f7d36b5c6883c314db7323c4a79a497e0973e0ec671c02c6b38f0f533f2c" "$root_stage/release-index.json" || fail "Sealed release index changed."
sudo -n sh -c 'printf "%s  %s\n" "$1" "$2" | sha256sum -c --status' sh "01b228ec64cee2c46d17db5279766d1ef39612a94c4309516f4c7ce08aa957b4" "$root_stage/release-index.sigstore.json" || fail "Sealed release signature changed."
...
sudo -n /usr/local/libexec/stateport-execution-host-provision materialize \
  ...
  --updater-wheel "$tmp/updater" --updater-wheel-digest "sha256:5f4d43a9d058e1f972166b9040295ca178774b20143aa808c2b234cdf1d963fb" \

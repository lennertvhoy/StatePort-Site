...
**Project State:** alpha3_published_clean_install_evidence_human_acceptance_pending
...
Complete the public-URL clean-install proof from the live GitHub Pages bootstrap
on the receipted Ubuntu 24.04 host, capture the receipt and seven-image/index
verification summary, then record the outcome without changing product code or
alpha.2 artifacts.

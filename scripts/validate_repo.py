...
def validate_release_semantics() -> None:
    ...
    for marker in (
        "Repaired public-test path enabled.",
        "diagnostic only",
        BOOTSTRAP_SHA256,
    ):
...
def main() -> None:
    ...
    require_text("releases/index.html", "repaired WSL2 public-test path enabled")
    require_text("download/index.html", "Do not install Alpha.2")
    require_text("docs/limitations.html", "repaired public-test path enabled")

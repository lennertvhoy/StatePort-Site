...
def main() -> None:
    ...
    require_text("index.html", "StudyState")
    require_text("index.html", "Follow the learner journey")
    require_text("index.html", "Undo remains available")
    require_text("index.html", "Platform evidence, one layer deeper")
